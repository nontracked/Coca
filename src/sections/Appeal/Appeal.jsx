      ...
      <div className="appeal__inner">
        <header className="appeal__header">
          ...
          <div className="appeal__desc">
            <p>
              ...
              <span
                className="appeal__mail-link"
                title="Click to copy"
                data-js-appeal-mail-link=""
              >
                hellosansbrothers@gmail.com
              </span>
              <span
                className="appeal__mail-link-tooltip"
                data-js-appeal-mail-link-tooltip=""
              >
                Copy!
              </span>
            </p>
        ...
        <div className="appeal__body">
          <form className="appeal__form" name={formId} id={formId} action="">
            ...
            />
            <Field
              className="appeal__form-cell appeal__form-cell--wide"
              label="Email"
